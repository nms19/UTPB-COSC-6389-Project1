...
class UI(tk.Tk):
    ...
    def run(self):
        ...
        def generation_step(generation=0, pop=None):
            ...
            # Scheduling the UI updates in main thread
            ...
            # Schedule the next generation step after a delay, unless we're at the global optimum (fitness == 1)
            if best_fitness < 1:
